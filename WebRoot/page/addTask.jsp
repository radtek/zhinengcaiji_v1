...
<html>
	...
	<body>
		<form action="/page/task" method="post" id="modifForm">
            ...
            <tr>
        <td height="30" colspan="3"><span class="currentTitle">添加任务</span></td>
        </tr>
        <tr>
        <td height="30" colspan="3" style="BORDER-BOTTOM: #d4d4d4 1px dashed; height: 2px;"></td>
				...
				<tr>
							...
							<tr>
								...
								<td>
									<input type="text" name="proxyDevId" id="proxyDevId"
										value="${requestScope.result.data.proxyDevId }" />
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<input type="text" name="proxyDevPort" id="proxyDevPort"
										value="${requestScope.result.data.proxyDevPort }" />
								</td>
							</tr>
							<tr>
								<td>
							...
							<tr>
								...
								<td>
									<input type="text" name="collectTimeout" id="collectTimeout"
										value="${requestScope.result.data.collectTimeout }" />
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<input type="text" name="collectTime" id="collectTime"
										value="${requestScope.result.data.collectTime }" />
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<input type="text" name="shellTimeout" id="shellTimeout"
										value="${requestScope.result.data.shellTimeout }" />
								</td>
							</tr>
							<tr>
								<td>
                            ...
                            <tr>
								...
								<td>
									<input type="text" name="groupId" id="groupId"
										value="${requestScope.result.data.groupId }" />
								</td>
							</tr>
						</table>
					</td>
				  ...
				  <tr>
				    <td><textarea name="collectPath" id="collectPath" rows="20"
										cols="40">${requestScope.result.data.collectPath }</textarea></td>
			      </tr>
				  <tr>
