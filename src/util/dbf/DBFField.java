 ...
 * 
 * DBFField objects are either created and added to a DBFWriter object or obtained from DBFReader object through getField( int) query.
 */
public class DBFField {
	 ...
	 * 
	 * If the field is specified to hold integral values the value returned by this method will be zero.
	 * 
