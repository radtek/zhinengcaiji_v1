...
public class Base64 {
	 ...
	 * </p>
	 * <p>
	 * If data are large, i.e. if you are working with large binary files, consider to use a {@link Base64OutputStream} instead of loading too much
	 * data in memory.
	 * </p>
	 * 
	 * @param bytes
	 ...
	 * </p>
	 * <p>
	 * If data are large, i.e. if you are working with large binary files, consider to use a {@link Base64InputStream} instead of loading too much
	 * data in memory.
	 * </p>
	 * 
	 * @param bytes
	...
	/**
	 * <p>
	 * Encodes data from the given input stream and writes them in the given output stream, wrapping every encoded line every <em>wrapAt</em>
	...
	/**
	 * <p>
	 * Encodes data from the given source file contents and writes them in the given target file, wrapping every encoded line every <em>wrapAt</em>
	 * characters. A <em>wrapAt</em> value less than 1 disables wrapping.
	 * </p>
	 * 
	 * @param source
