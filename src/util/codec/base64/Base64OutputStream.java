...
public class Base64OutputStream extends OutputStream {
	 ...
	 * </p>
	 * <p>
	 * The encoded data is wrapped to a new line (with a CRLF sequence) every <em>wrapAt</em> bytes sent to the underlying stream. If the
	 * <em>wrapAt</em> supplied value is less than 1 the encoded data will not be wrapped.
	 * </p>
	 * 
	 * @param outputStream
	 *            The underlying stream.
