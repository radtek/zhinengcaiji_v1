 ...
 */
public class XinJiangUeParser extends Parser {
	...
	public boolean parseData() throws Exception {
		...
		// currentpath要配到innerdata这一级目录。
		File mdn_target = new File(SystemConfig.getInstance().getCurrentPath() + File.separator + "MDN_INDEX.zip");
	...
	private void initSqlldr() throws Exception {
		ctlWriter.println("LOAD DATA\n" + "CHARACTERSET " + SystemConfig.getInstance().getSqlldrCharset() + "\n" + "INFILE '"
				+ sqlldrTxt.getAbsolutePath() + "' APPEND INTO TABLE " + TAC_INFO_STORE_TABLE + "\n" + "FIELDS TERMINATED BY \"|\"\n"
	...
	public static void main(String[] args) throws Exception {
		XinJiangUeParser p = new XinJiangUeParser();
		p.fileName = "E:\\uway\\requiredment\\igp1\\xinjiang\\20141101001_5000000.txt";
