 ...
 */
public class TianjinTXTUeParser extends Parser {

	private static final Logger logger = LogMgr.getInstance().getSystemLogger();

	public static String FILED_SEP = ",";
	...
	public static void main(String[] args) throws Exception {
		TianjinTXTUeParser p = new TianjinTXTUeParser();
		p.FILED_SEP = "|";
		p.fileName = "E:\\uway\\requiredment\\igp1\\终端\\天津\\201412_2\\20141201001_1219042.txt";
