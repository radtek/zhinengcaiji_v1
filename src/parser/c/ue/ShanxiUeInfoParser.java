...
/**
 * 山西的（2013-02-17）。 CDMA终端级优化，终端信息解析。 字段： MEID MDN IMSI 省公司 城市 终端厂商 手机型号 软件版本号 注册时间
 * 
 * @author ChenSijiang
 */
public class ShanxiUeInfoParser extends Parser {
